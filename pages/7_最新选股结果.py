...
<style>
  ...
  .board-lang-zh { color:#F5F8F7; font-size:.9rem; animation:boardZh 13s linear infinite; }
  .board-lang-en { animation:boardEn 13s linear infinite; }
  ...
  .board-name-scroll .board-en-text { max-width:none; overflow:visible; text-overflow:clip; white-space:nowrap;
    animation:boardNameMarquee 13s linear infinite; }
